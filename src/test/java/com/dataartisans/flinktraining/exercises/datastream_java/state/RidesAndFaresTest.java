...
public class RidesAndFaresTest extends TaxiRideTestBase<Tuple2<TaxiRide, TaxiFare>> {
    ...
    public void testInOrder() throws Exception {
        ...
        ArrayList<Tuple2<TaxiRide, TaxiFare>> expected =
            Lists.newArrayList(new Tuple2<>(ride1, fare1), new Tuple2<>(ride2, fare2));
    ...
    private TaxiRide testRide(long rideId) {
        return new TaxiRide(rideId, true, new DateTime(0), new DateTime(0), 0F, 0F, 0F, 0F, (short)1, 0, rideId);
    }
