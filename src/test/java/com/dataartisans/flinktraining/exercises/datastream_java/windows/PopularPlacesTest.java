...
public class PopularPlacesTest extends TaxiRideTestBase<Tuple5<Float, Float, Long, Boolean, Integer>> {
    ...
    public void testPopularPlaces() throws Exception {
        ...
        TestRideSource source = new TestRideSource(penn0, t(0), t(5), penn6, t(10), penn14, moma15a, moma15b, moma15c,
            t(15), t(20), t(25), t(30), t(35));
        ...
        Tuple5<Float, Float, Long, Boolean, Integer> penn10 =
            new Tuple5<>(pennStationLon, pennStationLat, t(10), true, 2);
        Tuple5<Float, Float, Long, Boolean, Integer> penn15 =
            new Tuple5<>(pennStationLon, pennStationLat, t(15), true, 3);
        Tuple5<Float, Float, Long, Boolean, Integer> penn20 =
            new Tuple5<>(pennStationLon, pennStationLat, t(20), true, 2);
        ...
        ArrayList<Tuple5<Float, Float, Long, Boolean, Integer>> expected =
            Lists.newArrayList(penn10, penn15, penn20, moma20, moma25, moma30);
    ...
    protected TaxiRide startRide(long rideId, long startTime, float startLon, float startLat) {
        return new TaxiRide(rideId, true, new DateTime(startTime), new DateTime(0), startLon, startLat, startLon,
            startLat, (short)1, 0, 0);
    }

    protected TaxiRide endRide(TaxiRide started, long endTime, float endLon, float endLat) {
        return new TaxiRide(started.rideId, false, started.startTime, new DateTime(endTime), started.startLon,
            started.startLat, endLon, endLat, (short)1, 0, 0);
    }
