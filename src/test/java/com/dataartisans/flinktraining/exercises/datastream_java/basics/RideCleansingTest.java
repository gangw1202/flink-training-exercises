...
public class RideCleansingTest extends TaxiRideTestBase<TaxiRide> {
    ...
    private TaxiRide testRide(float startLon, float startLat, float endLon, float endLat) {
        return new TaxiRide(1L, true, new DateTime(0), new DateTime(0), startLon, startLat, endLon, endLat, (short)1, 0,
            0);
    }

    protected List<?> results(TestRideSource source) throws Exception {
        Testable javaSolution =
            () -> com.dataartisans.flinktraining.solutions.datastream_java.basics.RideCleansingSolution
                .main(new String[] {});
