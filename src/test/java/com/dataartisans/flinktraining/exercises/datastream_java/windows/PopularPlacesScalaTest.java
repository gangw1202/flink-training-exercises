...
public class PopularPlacesScalaTest extends PopularPlacesTest {
    ...
    protected List<Tuple5<Float, Float, Long, Boolean, Integer>> results(TestRideSource source) throws Exception {
        Testable scalaSolution =
            () -> com.dataartisans.flinktraining.solutions.datastream_scala.windows.PopularPlacesSolution
                .main(new String[] {"-threshold", "2"});
    ...
    private ArrayList<Tuple5<Float, Float, Long, Boolean, Integer>>
        javaTuples(ArrayList<scala.Tuple5<Float, Float, Long, Boolean, Integer>> a) {
