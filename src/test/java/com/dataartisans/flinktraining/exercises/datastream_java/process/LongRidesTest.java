...
public class LongRidesTest extends TaxiRideTestBase<TaxiRide> {
    ...
    static Testable javaCEPExercise =
        () -> com.dataartisans.flinktraining.exercises.datastream_java.cep.LongRidesExercise.main(new String[] {});
    ...
    protected List<TaxiRide> cepResults(TestRideSource source) throws Exception {
        Testable javaCEPSolution =
            () -> com.dataartisans.flinktraining.solutions.datastream_java.cep.LongRidesSolution.main(new String[] {});
