...
/**
 * Java reference implementation for the "Ongoing Rides" exercise of the Flink training (http://training.ververica.com).
 *
 * The goal of this exercise is to report on all taxis whose current ride has been ongoing for at least n minutes
 * whenever the broadcast stream is queried (with the value of n).
 *
...
public class OngoingRidesSolution extends ExerciseBase {
    public static void main(String[] args) throws Exception {
        ...
        final MapStateDescriptor<Long, Long> dummyBroadcastState =
            new MapStateDescriptor<>("dummy", BasicTypeInfo.LONG_TYPE_INFO, BasicTypeInfo.LONG_TYPE_INFO);
        ...
        BroadcastStream<String> queryStream = env.socketTextStream("localhost", 9999)
            .assignTimestampsAndWatermarks(new QueryStreamAssigner()).broadcast(dummyBroadcastState);

        DataStream<TaxiRide> reports =
