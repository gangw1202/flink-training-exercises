...
public class NearestTaxiWithCleanupSolution extends ExerciseBase {
    ...
    private static class Query {
        ...
        public String toString() {
            return "Query{" + "id=" + queryId + ", longitude=" + longitude + ", latitude=" + latitude + ", timestamp="
                + timestamp + '}';
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        BroadcastStream<Query> queryStream = env.socketTextStream("localhost", 9999)
            .assignTimestampsAndWatermarks(new QueryStreamAssigner()).map(new MapFunction<String, Query>() {
                @Override
    ...
    public static class ClosestTaxi
        ...
        @Override
        public void onTimer(long timestamp, OnTimerContext ctx, Collector<Tuple3<Long, Long, Float>> out)
            throws Exception {
