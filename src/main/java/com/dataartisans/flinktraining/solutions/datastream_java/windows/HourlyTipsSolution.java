...
/**
 * Java reference implementation for the "Hourly Tips" exercise of the Flink training (http://training.ververica.com).
 *
 * The task of the exercise is to first calculate the total tips collected by each driver, hour by hour, and then from
 * that stream, find the highest tip total in each hour.
 *
...
public class HourlyTipsSolution extends ExerciseBase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple3<Long, Long, Float>> hourlyTips =
            fares.keyBy((TaxiFare fare) -> fare.driverId).timeWindow(Time.hours(1)).process(new AddTips());
