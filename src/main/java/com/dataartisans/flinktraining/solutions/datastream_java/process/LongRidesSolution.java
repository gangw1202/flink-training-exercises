...
/**
 * Solution to the "Long Ride Alerts" exercise of the Flink training (http://training.data-artisans.com).
 *
...
public class LongRidesSolution extends ExerciseBase {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<TaxiRide> longRides = rides.keyBy(r -> r.rideId).process(new MatchFunction());
