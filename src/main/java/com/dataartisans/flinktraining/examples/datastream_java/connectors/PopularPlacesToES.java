 ...
 * the last 15 minutes. The results are written into an Elasticsearch index.
 *
...
public class PopularPlacesToES {
    ...
    public static class PopularPlaceInserter
        ...
        @Override
        public void process(Tuple5<Float, Float, Long, Boolean, Integer> record, RuntimeContext ctx,
            ...
            IndexRequest rqst = Requests.indexRequest().index("nyc-places") // index name
