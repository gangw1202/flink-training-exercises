 ...
 * <p>
 * The task of the exercise is to divide the input stream of ConnectedCarEvents into session windows, defined by a gap
 * of 15 seconds. Each window should then be mapped onto a GapSegment object.
 * <p>
...
public class DrivingSessions {
    ...
    public static void main(String[] args) throws Exception {
        ...
        events.keyBy("carId").window(EventTimeSessionWindows.withGap(Time.seconds(15))).apply(new CreateGapSegment())
            .print();
