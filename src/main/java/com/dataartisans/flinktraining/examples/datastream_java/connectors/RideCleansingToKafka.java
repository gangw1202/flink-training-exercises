 ...
 *
 * The task of the exercise is to filter a data stream of taxi ride records to keep only rides that start and end within
 * New York City. The resulting stream is written to an Apache Kafka topic.
 *
...
public class RideCleansingToKafka {
    ...
    public static void main(String[] args) throws Exception {
        ...
        filteredRides.addSink(
            new FlinkKafkaProducer011<TaxiRide>(LOCAL_KAFKA_BROKER, CLEANSED_RIDES_TOPIC, new TaxiRideSchema()));
