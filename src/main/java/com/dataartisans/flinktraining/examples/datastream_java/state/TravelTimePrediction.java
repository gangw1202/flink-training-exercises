 ...
 *
 * The task of the exercise is to continuously train a regression model that predicts the travel time of a taxi based on
 * the information of taxi ride end events. For taxi ride start events, the model should be queried to estimate its
 * travel time.
 *
...
public class TravelTimePrediction {
    ...
    /**
     * Predicts the travel time for taxi ride start events based on distance and direction. Incrementally trains a
     * regression model using taxi ride end events.
     */
