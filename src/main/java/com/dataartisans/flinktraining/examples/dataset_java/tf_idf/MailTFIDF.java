...
/**
 * Java reference implementation for the "TF-IDF" exercise of the Flink training. The task of the exercise is to compute
 * the TF-IDF score for words in mails of the Apache Flink developer mailing list archive.
 *
 * Required parameters: --input path-to-input-directory
 *
 */
public class MailTFIDF {

    public final static String[] STOP_WORDS =
        {"the", "i", "a", "an", "at", "are", "am", "for", "and", "or", "is", "there", "it", "this", "that", "on", "was",
            "by", "of", "to", "in", "to", "message", "not", "be", "with", "you", "have", "as", "can"};
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple2<String, String>> mails = env.readCsvFile(input).lineDelimiter(MBoxParser.MAIL_RECORD_DELIM)
            .fieldDelimiter(MBoxParser.MAIL_FIELD_DELIM).includeFields("10001").types(String.class, String.class);
        ...
        DataSet<Tuple3<String, String, Integer>> termFrequency = mails.flatMap(new TFComputer(STOP_WORDS));
    ...
    /**
     * Extracts the all unique words from the mail body. Words consist only of alphabetical characters. Frequent words
    ...
    /**
     * Computes the frequency of words in a mails body. Words consist only of alphabetical characters. Frequent words
     * (stop words) are filtered out.
     */
     ...
     */
    public static class TfIdfComputer implements
        ...
        public Tuple3<String, String, Double> join(Tuple2<String, Integer> docFreq,
            Tuple3<String, String, Integer> termFreq) throws Exception {
            // compute TF-IDF
