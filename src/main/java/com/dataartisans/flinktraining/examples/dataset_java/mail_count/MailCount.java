...
/**
 * Java reference implementation for the "Mail Count" exercise of the Flink training. The task of the exercise is to
 * count the number of mails sent for each month and email address.
 *
...
public class MailCount {
     ...
     */
    public static class MailCounter
