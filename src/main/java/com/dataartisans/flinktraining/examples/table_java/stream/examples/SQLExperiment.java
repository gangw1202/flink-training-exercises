...
public class SQLExperiment {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Table results = tEnv.sqlQuery(
            "SELECT TUMBLE_END(eventTime, INTERVAL '1' HOUR) AS wend, driverId, SUM(tip) as tips " + "FROM TaxiFares "
                + "GROUP BY driverId, TUMBLE(eventTime, INTERVAL '1' HOUR) " + "HAVING SUM(tip) > 50");
