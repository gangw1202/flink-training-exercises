...
/**
 * Demonstrates the use of {@link TaxiDataCatalog} to easily register the taxi data as tables under the "nyc" schema,
 * e.g. {@code nyc.TaxiRides} and {@code nyc.TaxiFares}.
 */
public class ViaCatalog {
    public static void main(String[] args) throws Exception {
        ...
        int servingSpeedFactor = params.getInt("servingSpeedFactor", 1800); // events of 30 minutes are served in 1
                                                                            // second
        ...
        tEnv.registerExternalCatalog("nyc",
            new TaxiDataCatalog(ridesFile, faresFile, maxEventDelay, servingSpeedFactor));
        ...
        Table results = tEnv.sqlQuery("" + "SELECT f.rideId, f.driverId, f.totalFare "
