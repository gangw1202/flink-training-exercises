...
public class PopularPlacesSql {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Table results =
            tEnv.sqlQuery("SELECT " + "toCoords(cell), wstart, wend, isStart, popCnt " + "FROM " + "(SELECT " + "cell, "
                + "isStart, " + "HOP_START(eventTime, INTERVAL '5' MINUTE, INTERVAL '15' MINUTE) AS wstart, "
                ...
                + "FROM TaxiRides " + "WHERE isInNYC(startLon, startLat) AND isInNYC(endLon, endLat)) "
