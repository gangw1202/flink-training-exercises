...
/**
 * Java reference implementation for the "Member of the Month" exercise of the Flink training. The task of the exercise
 * is to identify for each month the email address that sent the most emails to the Flink developer mailing list.
 *
...
public class MemberOTMonth {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple2<String, String>> mails = env.readCsvFile(input).lineDelimiter(MBoxParser.MAIL_RECORD_DELIM)
            .fieldDelimiter(MBoxParser.MAIL_FIELD_DELIM).includeFields("011").types(String.class, String.class);
        ...
        Table mailsPerSenderMonth = tEnv
            ...
            .filter("sender !== 'jira@apache.org' && " + "sender !== 'no-reply@apache.org' && "
