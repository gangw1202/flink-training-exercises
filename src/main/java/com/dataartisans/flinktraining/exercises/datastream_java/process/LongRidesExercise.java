...
/**
 * The "Long Ride Alerts" exercise of the Flink training (http://training.data-artisans.com).
 *
...
public class LongRidesExercise extends ExerciseBase {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<TaxiRide> longRides = rides.keyBy(ride -> ride.rideId).process(new MatchFunction());
