...
/**
 * The "Ride Cleansing" exercise from the Flink training (http://training.data-artisans.com). The task of the exercise
 * is to filter a data stream of taxi ride records to keep only rides that start and end within New York City. The
 * resulting stream should be printed.
 *
