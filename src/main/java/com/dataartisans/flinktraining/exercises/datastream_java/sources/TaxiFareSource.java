...
/**
 * This SourceFunction generates a data stream of TaxiFare records which are read from a gzipped input file. Each record
...
public class TaxiFareSource implements SourceFunction<TaxiFare> {
    ...
    /**
     * Serves the TaxiFare records from the specified and ordered gzipped input file. Rides are served exactly in order
    ...
    /**
     * Serves the TaxiFare records from the specified and ordered gzipped input file. Rides are served out-of time stamp
    ...
    private void generateUnorderedStream(SourceContext<TaxiFare> sourceContext) throws Exception {
        ...
        PriorityQueue<Tuple2<Long, Object>> emitSchedule =
            new PriorityQueue<>(32, new Comparator<Tuple2<Long, Object>>() {
                @Override
