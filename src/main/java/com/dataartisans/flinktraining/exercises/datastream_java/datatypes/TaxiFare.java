 ...
 *
 * A TaxiFare consists of - the rideId of the event - the time of the event
 *
 */
public class TaxiFare implements Serializable {
    ...
    public TaxiFare(long rideId, long taxiId, long driverId, DateTime startTime, String paymentType, float tip,
