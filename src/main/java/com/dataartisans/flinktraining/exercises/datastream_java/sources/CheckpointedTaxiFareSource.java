 ...
 *
 * In order to simulate a realistic stream source, the SourceFunction serves events proportional to their timestamps.
 *
 ...
 *
 * In addition it implements the Checkpointed interface and can hence able to recover from failures if the job enables
 * checkpointing as follows:
 *
