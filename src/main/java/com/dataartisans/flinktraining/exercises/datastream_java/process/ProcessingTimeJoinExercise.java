...
/*
 * This is the simplest possible enrichment join, used to enrich a stream of financial Trades with Customer data. When
 * we receive a Trade we immediately join it with whatever Customer data is available.
 */
...
public class ProcessingTimeJoinExercise {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<EnrichedTrade> joinedStream = tradeStream.keyBy("customerId")
            .connect(customerStream.keyBy("customerId")).process(new ProcessingTimeJoinFunction());
    ...
    public static class ProcessingTimeJoinFunction extends CoProcessFunction<Trade, Customer, EnrichedTrade> {
        ...
        public void open(Configuration config) {
            ValueStateDescriptor<Customer> cDescriptor =
                new ValueStateDescriptor<>("customer", TypeInformation.of(Customer.class));
