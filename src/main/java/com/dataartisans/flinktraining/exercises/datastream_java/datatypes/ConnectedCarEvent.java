 ...
 *
 * A ConnectedCarEvent consists of - an id - the time of the event - the longitude - the latitude - the speed - the
 * throttle position (%) - the engine load (%)
 */
public class ConnectedCarEvent implements Comparable<ConnectedCarEvent> {
    ...
    public boolean equals(Object other) {
        return other instanceof ConnectedCarEvent && this.id == ((ConnectedCarEvent)other).id;
    }
