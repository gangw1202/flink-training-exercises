...
public class Segment {
    ...
    public String toString() {
        ...
        sb.append(startTime).append(",").append(length).append(" events,").append(maxSpeed).append(" kph,")
    ...
    public boolean equals(Object other) {
        return other instanceof Segment && Objects.equals(this.startTime, ((Segment)other).startTime);
    }
