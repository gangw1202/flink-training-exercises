...
/**
 * Converts MBox archive files of Apache Flink's developer mailing list into a processable text-based, delimited file
 * format. For MBox files of different mailing lists, the MAIL_DAEMON_PREFIX parameter needs to be adapted.
 *
 * Mail records are separated by "##//##" and record fields are separated by "#|#".
 *
 * Mail records have six fields: - MessageID : String (unique) - Time : String - Sender : String - Subject : String -
 * Body : String - Reply-To : String (points a MessageID, might be "null")
 *
 * Parameters: --input path-to-mbox-files --output path-to-output
 *
 */
public class MBoxParser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<String> rawMails = env.readFile(new MBoxMailFormat(MAIL_DAEMON_PREFIX), input);
    ...
    /**
     * InputFormat that splits MBox files into strings of individual mails. Each mail becomes a String.
     */
     ...
     */
    public static class MBoxMailParser
        extends RichFlatMapFunction<String, Tuple6<String, String, String, String, String, String>> {
